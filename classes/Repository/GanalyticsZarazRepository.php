...
namespace PickleBoxer\Ps_GoogleanalyticsZaraz\Repository;

use Db;

class GanalyticsZarazRepository
{
    const TABLE_NAME = 'ganalyticszaraz';
     ...
     * @return mixed
     */
    public function findGazOrderByOrderId($orderId)
    {
